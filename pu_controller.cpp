// Edited: Feb 24 2017: ver.01
/*
	Edit: Want to add documentation and figure out what the code does.
...
PickUpController::PickUpController() {
    lockTarget = false;					// targetLockedOn: bool, whether a target is locked
    timeOut = false;					// 
    nTargetsSeen = 0;					// noTargetSeen: bool, if there is a cube visible: is seen as a red circle on GUI
    blockYawError = 0;
    blockDist = 0;
    td = 0;
...
PickUpResult PickUpController::pickUpSelectedTarget(bool blockBlock) {
  ...
  result.giveUp = false;*/
	...
	// nTargetsSeen = noTargetSeen: bool
